  ...
  return [
    {
      ...
      description:
        "Immerse yourself in the world's first Bitcoin economy. Learn, surf, and transact entirely in BTC.",
      price: 0.1,
      cryptoCurrency: "BTC",
    ...
    },
    {
      ...
      description:
        "Attend a major crypto conference and explore Miami's burgeoning crypto scene and Bitcoin-friendly businesses.",
      price: 0.5,
      cryptoCurrency: "ETH",
    ...
    },
    {
      ...
      description:
        "Visit Zug, the heart of Crypto Valley. Tour blockchain startups and enjoy the crypto-friendly atmosphere.",
      price: 2,
      cryptoCurrency: "ETH",
  ...
  if (isLoading) {
    return (
      <div className="text-center py-10">
        Loading crypto-friendly experiences...
      </div>
    );
  }
  ...
  return (
    <>
      <h2 className="text-3xl font-bold mb-6">
        Crypto-Friendly Travel Experiences
      </h2>
            ...
            <div className="p-4">
                  ...
                  {[...Array(5)].map((_, i) => (
                    <span
                      ...
                      className={`text-yellow-500 ${
                        i < experience.cryptoFriendlinessScore
                          ? "opacity-100"
                          : "opacity-30"
                      }`}
                    >
              ...
              <div className="flex items-center mt-2">
                ...
                {experience.acceptedCryptos.map((crypto) => (
                  <span key={crypto} className="mr-1">
